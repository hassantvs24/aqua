  ...
  return (
    <div
      ...
      */}
      ...
      <div
        className="modal-trigger d-inline-block"
        data-targetmodal={'eggnew'}
...
const PenButton = (props) => {
  ...
  return (
    <div
      ...
      {/*
      <div className="text-left section-content">
        <div className="section-number">03.</div>
        <h2 className="section-title">
          THE SMOLT SALMON IS PLACED IN OCEAN BASED CLOSED PENS
        </h2>
        <div className="section-text text mt-3">
          When the smolt I ready it is transported from land to the Ocean where
  ...
  return (
    <div
      ...
      <div className="text-center text-md-left section-content">
        ...
        <h2 className="section-title">
          AND THERE IS GROWS INTO A LARGE SALMON
        </h2>
        <div className="section-text text mt-3">
...
const Ui3dButtons = (props) => {
  ...
  return (
    <div id="ui-3d-buttons">
      <EggButton scroll3D={props.scroll3D} />
      <SmoltButton scroll3D={props.scroll3D} />
      <PenButton scroll3D={props.scroll3D} />
      <AdultButton scroll3D={props.scroll3D} />
      {/* {scrollState3d >= 300 ? <StageButtons scroll3D={props.scroll3D} /> : ""} */}
    </div>
  )
}

export default Ui3dButtons
