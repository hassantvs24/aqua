...
const GrowModel = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useLoader(GLTFLoader, '/models/juan/008/smolt-to-adult-ver-14.glb')
  ...
  return (
    ...
    <group rotation={[0, 4, 0]} position={[0, 0, 0]}>
      <mesh
  ...
  return (
    ...
    <div id="panel-fish"  style={{padding:'56.25% 0 0 0',position:'relative'}}>
      ...
      <Canvas onMouseMove={e => (mouse.current = getMousePos(e))} id="fish-canvas" shadowMap camera={{ position: [0, 0, 15] }}>
        ...
        />    
        */}
         <PerspectiveCamera makeDefault position= {[6, 0, 30]} >   
             {/*  />      
              <hemisphereLight
              position={[205, 0, 50]}         
              intensity={0.25}
      ...
      <div id="fish-text">
        <h2>Smolt to Adult Salmon Growth</h2>
        <br/>
...
export default PanelGrow;

/*
const group = useRef()
  const { nodes, materials, animations } = useLoader(GLTFLoader, '/models/juan/005/smolt-to-adult-ver-13.gltf')
...
/*
 const group = useRef()
  const { nodes, materials, animations } = useLoader(GLTFLoader, '/models/juan/004/smolt-to-adult-ver-13.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null} position={[-9, -4, 0]} scale={[.4, .4, .4]} >
      <group rotation={[0, 10, 0]} position={[0, 0, 0]}>
        <mesh
          material={materials.Testt}
          geometry={nodes.Smolt.geometry}
          name="Smolt"
