...
//        console.log(ref.current.position.y,'posY', curTop, 'curTop', nextY,'nextY' )
      ...
      case (curTop >= scrollEgg && curTop <= scrollEggSmolt ) :
        ...
        // zoom in
//        if(camera.position.x < camEggDefPosX){
//          camera.position.x = camera.position.x + (camSpeedHatch / 2.85 )
//        }   
        /*     
        if(camera.position.y < camEggDefPosY){
          camera.position.y = camera.position.y + camSpeedHatch
        }*/
//        if(camera.position.z > camEggDefPosZ){
...
const SmoltPanel = (props) => {
  ...
  useEffect(() => {
    ...
    /*
    camera.position.x = camera.position.x + camPosX 
    camera.position.y = camera.position.y + camPosY 
    camera.position.z = camera.position.z + camPosZ 
    */
    ...
    switch (true){
      ...
      case (curTop >= scrollEggSmolt &&  curTop <= scrollSmoltGrow) :
        ...
        */        
        ...
        // zoom out
//        if(camera.position.x > camSmoltDefPosX){
//          camera.position.x = lerp((curTop / 100 -7) * -1, nextY * -1, 0.001) 
//          camera.position.z = lerp((curTop / 100 -7) , nextY , 0.1) 
...
//        }   
        /*     
        if(camera.position.y < camSmoltDefPosY){
          camera.position.y = camera.position.y + camSpeedHatch
        }*/
/*        if(camera.position.z < camSmoltDefPosZ){
          camera.position.z = camera.position.z + camSpeedHatch
        }  */
        break
